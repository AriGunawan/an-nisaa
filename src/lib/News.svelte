			...
			{#each news as { title, summary, imageUrl, hasContent, date, instagramTvId, isImageOnly }}
				{#if instagramTvId}
					<blockquote
						...
						data-instgrm-permalink={`https://www.instagram.com/tv/${instagramTvId}/?utm_source=ig_embed&amp;utm_campaign=loading`}
					...
					>
						<div style="padding:16px;">
							<a
								href={`https://www.instagram.com/tv/${instagramTvId}/?utm_source=ig_embed&amp;utm_campaign=loading`}
							...
							>
								<a
									href="https://www.instagram.com/tv/Cb6k-DRBDiW/?utm_source=ig_embed&amp;utm_campaign=loading"
									style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px; text-decoration:none;"
									target="_blank"
									>A post shared by An-Nisaa&#39; ~ Muslimah Berkarya (@kajian.annisaa)</a
								>
							</p>
						</div>
					</blockquote>
